...
import {
    ...
    ModalBody,
    ModalCloseButton,
    Flex, Table,Thead,Tbody,Th,Td,Tr, Button,Box ,FormControl,FormLabel,Spinner,Input,Select
  } from "@chakra-ui/react"

export default function UpdatePredio({show,set,dados}) 
{
    ...
    return (
        <Modal isOpen={show} onClose={()=>console.log("Closed")} size="1000px" >
                    <ModalContent>
                    ...
                    <Flex height="80vh" justifyContent="center" alignItems="center">
                            ...
                            <Box width="20%" marginRight="10px">
                                ...
                                <FormControl id="email" marginTop="25px">
                                    <Button 
                                    onClick={()=> console.log(dados.nome)}
                                        isLoading={loading}
